...
interface FilterState {
  ...
  periodFrom: string;
  periodTo: string;
  displayLocation: string; // "all" | "featured" | "in_museum" | "returned"
}
...
function FilterContent({ categories, filters, onFiltersChange, materials = [], regions = [] }: FilterSidebarProps) {
  const activeFiltersCount = 
    ...
    (filters.displayLocation && filters.displayLocation !== "all" ? 1 : 0);
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <Select
          ...
          onValueChange={(value) => onFiltersChange({ ...filters, displayLocation: value })}
        >
          ...
          <SelectContent>
            ...
            {/* <SelectItem value="featured">Featured Artifacts</SelectItem> */}
            <SelectItem value="in_museum">In the Museum</SelectItem>
            <SelectItem value="returned">Returned Artifacts</SelectItem>
          </SelectContent>
        </Select>
      </div>
