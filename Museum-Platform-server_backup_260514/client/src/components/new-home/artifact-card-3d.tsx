    ...
    <Link href={`/artifacts/${artifact.id}`}>
      <a className="block">
        <div className="mb-[20px] relative bg-[#EBEBEB33] rounded-[10px] overflow-hidden shadow-[2px_2px_4px_rgba(0,0,0,0.1)] hover:shadow-[4px_4px_8px_rgba(0,0,0,0.15)] transition-shadow">
          ...
          <div className="h-[300px] overflow-hidden flex items-center justify-center p-2.5 bg-white/10 backdrop-blur-[20px] border-b border-white/50 shadow-[inset_4px_4px_4px_rgba(0,0,0,0.03),inset_0_8px_10px_rgb(255_255_255)] rounded-t-[10px]">
