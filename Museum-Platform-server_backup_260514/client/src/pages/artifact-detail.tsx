...
export default function ArtifactDetailPage() {
  ...
  if (isLoading) {
    return (
      <MainLayout>
        <div className="bg-section-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
  ...
  if (!artifact) {
    return (
      <MainLayout>
        <div className="mt-[200px] mb-[10px] bg-section-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
  ...
  return (
    <MainLayout>
      ...
      {artifact?.has3dModel && isModelLoading && (
        <div className="bg-section-white fixed inset-0 z-50 bg-background/95 backdrop-blur-sm flex items-center justify-center">
      ...
      <SEOHead
        ...
        type="article"
      />
      <div className="bg-section-white pt-20 px-4 sm:px-6 lg:px-8" data-testid="artifact-detail">
