...
export function getSession() {
  ...
  return session({
    ...
    //   maxAge: sessionTtl,
    // },
    // have to change later to allow for local development without HTTPS - but should be secure in production
    cookie: {
      httpOnly: true,
      secure: false,
      sameSite: "lax",
...
// export const isAuthenticated: RequestHandler = async (req, res, next) => {
//   console.log("isAuthenticated sessionID:", req.sessionID);
